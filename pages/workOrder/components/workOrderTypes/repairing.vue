<template>
	<view class="page-wrapper">
		<!-- 工单列表 -->
		<view class="repairing-list-container">
			<view v-for="(item, index) in repairingListData" :key="index" class="list-item">
				<!-- 日期时间分隔符 -->
				<view class="time-tag">
				...
				<!-- 卡片内容 -->
				<view class="card" @click="goToRepairingWODetail(item.id)">
					<!-- 左侧图标 -->
