<template>
	<view class="page-wrapper">
		<!-- 工单列表 -->
		<view class="admin-review-list-container">
			<view v-for="(item, index) in adminReviewListData" :key="index" class="list-item">
				<!-- 日期时间分隔符 -->
				<view class="time-tag">
				...
				<!-- 卡片内容 -->
				<view class="card" @click="goToAdminReviewWODetail(item.id)">
					<!-- 左侧图标 -->
