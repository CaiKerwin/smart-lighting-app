<template>
	...
	<!-- #endif -->
	<!-- #ifdef WEB -->
	<div ref="chartContainer" :style="[styles, lStyle]" class="lime-echart"></div>
	<!-- #endif -->
	<!-- #ifdef APP-NVUE -->
	<view :style="[lStyle]" class="lime-echart">
		<web-view ref="chartContainer"
			:style="[styles]"
			:webview-styles="webviewStyles"
			class="lime-echart__canvas"
			src="/uni_modules/lime-echart/static/app/uvue.html?v=1"
			@onPostMessage="handleWebviewMessage"
			@pagefinish="isInitialized = true"></web-view>
	</view>
	<!-- #endif -->
</template>
